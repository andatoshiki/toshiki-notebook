import{_ as s,c as n,o as a,R as l}from"./chunks/framework.ade46834.js";const d=JSON.parse('{"title":"Compiler Flags","description":"","frontmatter":{"title":"Compiler Flags"},"headers":[],"relativePath":"application/vitepress-plugin-shiki-twoslash/config/flags.md","filePath":"application/vitepress-plugin-shiki-twoslash/config/flags.md","lastUpdated":1694920472000}'),e={name:"application/vitepress-plugin-shiki-twoslash/config/flags.md"},p=l(`<h1 id="compiler-flags" tabindex="-1">Compiler Flags <a class="header-anchor" href="#compiler-flags" aria-label="Permalink to &quot;Compiler Flags&quot;">​</a></h1><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki solarized-dark vp-code-dark"><code><span class="line"><span style="color:#839496;">// @allowJs</span></span>

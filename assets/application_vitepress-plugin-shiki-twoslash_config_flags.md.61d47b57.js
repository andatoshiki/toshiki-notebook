import{_ as a}from"./chunks/PageInfo.vue_vue_type_script_setup_true_lang.3a495ef9.js";import{_ as e,o as l,c as p,H as c,k as s,a as r,Q as o}from"./chunks/framework.575f3c30.js";import"./chunks/commonjsHelpers.725317a4.js";const k=JSON.parse('{"title":"Compiler Flags","description":"","frontmatter":{"title":"Compiler Flags"},"headers":[],"relativePath":"application/vitepress-plugin-shiki-twoslash/config/flags.md","filePath":"application/vitepress-plugin-shiki-twoslash/config/flags.md","lastUpdated":1726416295000}'),i={name:"application/vitepress-plugin-shiki-twoslash/config/flags.md"},t=s("h1",{id:"compiler-flags",tabindex:"-1"},[r("Compiler Flags "),s("a",{class:"header-anchor",href:"#compiler-flags","aria-label":'Permalink to "Compiler Flags"'},"​")],-1),b=o(`<div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark-dimmed vp-code-dark"><code><span class="line"><span style="color:#adbac7;">// @allowJs</span></span>

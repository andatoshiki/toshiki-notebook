import{_ as a}from"./chunks/PageInfo.vue_vue_type_script_setup_true_lang.250b3e56.js";import{_ as l,o as e,c as p,H as r,k as s,a as o,Q as c}from"./chunks/framework.b7580407.js";import"./chunks/commonjsHelpers.725317a4.js";const v=JSON.parse('{"title":"Compiler Flags","description":"","frontmatter":{"title":"Compiler Flags"},"headers":[],"relativePath":"application/vitepress-plugin-shiki-twoslash/config/flags.md","filePath":"application/vitepress-plugin-shiki-twoslash/config/flags.md","lastUpdated":1695377545000}'),i={name:"application/vitepress-plugin-shiki-twoslash/config/flags.md"},t=s("h1",{id:"compiler-flags",tabindex:"-1"},[o("Compiler Flags "),s("a",{class:"header-anchor",href:"#compiler-flags","aria-label":'Permalink to "Compiler Flags"'},"​")],-1),y=c(`<div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki solarized-dark vp-code-dark"><code><span class="line"><span style="color:#839496;">// @allowJs</span></span>
